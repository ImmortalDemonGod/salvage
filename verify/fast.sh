...
for s in verify/checks.gd verify/teach.gd verify/pillar.gd verify/select.gd verify/door.gd verify/audio.gd verify/layout.gd verify/fuzz.gd verify/differential.gd; do
  [ -f "$s" ] || continue
