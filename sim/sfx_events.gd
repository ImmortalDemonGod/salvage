...
enum Kind { NONE, HIT, BREAK, SHUTDOWN, TAKE, DOWN, WIN, LOSE, MOVE, REFUSE, VALVE, LOCK, CUT }
...
static func name_of(k: int) -> String:
	return ["none", "hit", "break", "shutdown", "take", "down", "win", "lose", "move", "refuse", "valve", "lock", "cut"][k]
